    ...
    <>
      <main className="w-full h-full">
        ...
        <div className="flex my-5">
          <Link href="/blog/add" className="md:w-1/6 sm:w-2/4 rounded-md text-center p-2 m-auto bg-slate-200 font-semibold">Add Post</Link>
        </div>
            ...
            <div className="w-3/4 p-4 rounded-md mx-3 my-2 bg-slate-200 flex flex-col justify-center">
              <div className="flex items-center-my-3">
                <div className="mr-auto">
                  <h2 className="mr-auto font-semilbold">{post.title}</h2>
                </div>
              </div>
            </div>
